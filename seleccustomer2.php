...
<?php
require "connect.php";
$sql = "SELECT customer.CustomerID, customer.Name, customer.Birthdate, customer.Email, country.CountryName, customer.OutstandingDebt FROM customer, country
        WHERE country.CountryCode=customer.CountryCode ORDER BY CustomerID asc";
